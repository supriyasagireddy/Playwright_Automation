                        ...
                        - grid "Table":
                          ...
                          - rowgroup:
                            - row "25-06-041 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-041":
                                - link "25-06-041":
                                  - /url: javascript:openProtocol('OB7136652665769146726','OB4259114407610333540','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB7522732592715380408','OB8023143557870407447',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-07-054 Atherton, Michael Yet to Submit to IRB NEW 0":
                              - gridcell "25-07-054":
                                - link "25-07-054":
                                  - /url: javascript:openProtocol('OB7696787196704109489','OB5160114164691846705','1','S')
                              - gridcell "Atherton, Michael"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB148604248856507998','OB5633831565442858222',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-045 Simon, Jones Resubmit the Protocol RETURNED 0":
                              - gridcell "25-06-045":
                                - link "25-06-045":
                                  - /url: javascript:openProtocol('OB4119318964967289434','OB705159928070123995','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Resubmit the Protocol":
                                - link "Resubmit the Protocol":
                                  - /url: "javascript:performAction('OB2081963495682912804','OB4713296037749110201',\n\t\t\t\t\t\t\t\t\t\t\t\t'Resubmit the Protocol',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "RETURNED"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-042 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-042":
                                - link "25-06-042":
                                  - /url: javascript:openProtocol('OB5043014611631321765','OB4461450847081640502','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB1703553299717574441','OB3618959058619187020',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-035 Simon, Jones Comments Received (Cycle 1) IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-035":
                                - link "25-06-035":
                                  - /url: javascript:openProtocol('OB7514489566456885383','OB2213738838566388295','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Comments Received (Cycle 1)":
                                - link "Comments Received (Cycle 1)":
                                  - /url: "javascript:performAction('OB6950536015520511972','OB5461617020347631727',\n\t\t\t\t\t\t\t\t\t\t\t\t'Comments Received (Cycle 1)',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'M',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                            ...
                            - row "25-06-036 Simon, Jones SUBMITTED TO IRB IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-036":
                                - link "25-06-036":
                                  - /url: javascript:openProtocol('OB7549174537150249985','OB8358734885832314008','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED TO IRB":
                                - link "SUBMITTED TO IRB":
                                  - /url: "javascript:performAction('OB2730543425476774813','OB2163492668269310837',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED TO IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'N',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "IN-PROGRESS"
                              - gridcell "IRB Panel"
                              - gridcell "20250706 07/06/2025": 07/06/2025
                            - row "25-06-047 Simon, Jones CONTINGENT CONTINGENT IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-047":
                                - link "25-06-047":
                                  - /url: javascript:openProtocol('OB7351922507548279701','OB6485458190333555830','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "CONTINGENT"
                              - gridcell "CONTINGENT"
                              - gridcell "IRB Panel"
                            ...
                            - row "25-06-034 Simon, Jones SUBMITTED to IRB SUBMITTED 0":
                              - gridcell "25-06-034":
                                - link "25-06-034":
                                  - /url: javascript:openProtocol('OB21331861835238421','OB3243432592542812831','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED to IRB":
                                - link "SUBMITTED to IRB":
                                  - /url: "javascript:performAction('OB1714665406311153188','OB159391169455831057',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "SUBMITTED"
                              - gridcell
                              - gridcell "0"
                    - row:
