                        ...
                        - grid "Table":
                          ...
                          - rowgroup:
                            - row "25-06-045 Simon, Jones Resubmit the Protocol RETURNED 0":
                              - gridcell "25-06-045":
                                - link "25-06-045":
                                  - /url: javascript:openProtocol('OB43487615279740753','OB3516351733711061408','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Resubmit the Protocol":
                                - link "Resubmit the Protocol":
                                  - /url: "javascript:performAction('OB7922171226008407828','OB9199891843492561356',\n\t\t\t\t\t\t\t\t\t\t\t\t'Resubmit the Protocol',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "RETURNED"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-041 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-041":
                                - link "25-06-041":
                                  - /url: javascript:openProtocol('OB2480334109149017159','OB8463980708893377643','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB8010204269622544467','OB5873424106875368838',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-042 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-042":
                                - link "25-06-042":
                                  - /url: javascript:openProtocol('OB2913845691488779250','OB4978491189855697842','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB1713649383273836902','OB1125183794441797210',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-035 Simon, Jones Comments Received (Cycle 1) IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-035":
                                - link "25-06-035":
                                  - /url: javascript:openProtocol('OB112124615069877486','OB33097613949907421','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Comments Received (Cycle 1)":
                                - link "Comments Received (Cycle 1)":
                                  - /url: "javascript:performAction('OB2210567388355868380','OB1632406989477427671',\n\t\t\t\t\t\t\t\t\t\t\t\t'Comments Received (Cycle 1)',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'M',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                            ...
                            - row "25-06-036 Simon, Jones SUBMITTED TO IRB IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-036":
                                - link "25-06-036":
                                  - /url: javascript:openProtocol('OB4338625512763507030','OB1386801080461904108','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED TO IRB":
                                - link "SUBMITTED TO IRB":
                                  - /url: "javascript:performAction('OB6205655964533607343','OB5883235130035292095',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED TO IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'N',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "IN-PROGRESS"
                              - gridcell "IRB Panel"
                              - gridcell "20250706 07/06/2025": 07/06/2025
                            - row "25-06-047 Simon, Jones CONTINGENT CONTINGENT IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-047":
                                - link "25-06-047":
                                  - /url: javascript:openProtocol('OB8301323924911047998','OB2983295953262917443','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "CONTINGENT"
                              - gridcell "CONTINGENT"
                              - gridcell "IRB Panel"
                            ...
                            - row "25-06-034 Simon, Jones SUBMITTED to IRB SUBMITTED 0":
                              - gridcell "25-06-034":
                                - link "25-06-034":
                                  - /url: javascript:openProtocol('OB8769993782322707541','OB7162009892723378401','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED to IRB":
                                - link "SUBMITTED to IRB":
                                  - /url: "javascript:performAction('OB1747974395669070689','OB575011600256027992',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "SUBMITTED"
                              - gridcell
                              - gridcell "0"
                    - row:
