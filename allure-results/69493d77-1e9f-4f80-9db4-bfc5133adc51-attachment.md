                        ...
                        - grid "Table":
                          ...
                          - rowgroup:
                            - row "25-06-045 Simon, Jones Resubmit the Protocol RETURNED 0":
                              - gridcell "25-06-045":
                                - link "25-06-045":
                                  - /url: javascript:openProtocol('OB6292616587257071309','OB308861303582311584','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Resubmit the Protocol":
                                - link "Resubmit the Protocol":
                                  - /url: "javascript:performAction('OB7921604182594205154','OB175156929827717256',\n\t\t\t\t\t\t\t\t\t\t\t\t'Resubmit the Protocol',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "RETURNED"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-042 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-042":
                                - link "25-06-042":
                                  - /url: javascript:openProtocol('OB2844403058824724792','OB7601720547373072327','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB8439236007087813479','OB7036177819377090913',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-041 Simon, Jones Yet to Submit to IRB NEW 0":
                              - gridcell "25-06-041":
                                - link "25-06-041":
                                  - /url: javascript:openProtocol('OB1842232510053699447','OB2129262999433099256','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Yet to Submit to IRB":
                                - link "Yet to Submit to IRB":
                                  - /url: "javascript:performAction('OB2938006597949242565','OB3095563650399421384',\n\t\t\t\t\t\t\t\t\t\t\t\t'Yet to Submit to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "NEW"
                              - gridcell
                              - gridcell "0"
                            - row "25-06-035 Simon, Jones Comments Received (Cycle 1) IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-035":
                                - link "25-06-035":
                                  - /url: javascript:openProtocol('OB4815723630510847348','OB5183760386063186146','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "Comments Received (Cycle 1)":
                                - link "Comments Received (Cycle 1)":
                                  - /url: "javascript:performAction('OB3441043109093228351','OB482167521682541264',\n\t\t\t\t\t\t\t\t\t\t\t\t'Comments Received (Cycle 1)',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'M',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                            ...
                            - row "25-06-036 Simon, Jones SUBMITTED TO IRB IN-PROGRESS IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-036":
                                - link "25-06-036":
                                  - /url: javascript:openProtocol('OB5203787618105838987','OB3112780299238685445','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED TO IRB":
                                - link "SUBMITTED TO IRB":
                                  - /url: "javascript:performAction('OB1463998957837202026','OB3674637824610026224',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED TO IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'N',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "IN-PROGRESS"
                              - gridcell "IRB Panel"
                              - gridcell "20250706 07/06/2025": 07/06/2025
                            - row "25-06-047 Simon, Jones CONTINGENT CONTINGENT IRB Panel 20250706 07/06/2025":
                              - gridcell "25-06-047":
                                - link "25-06-047":
                                  - /url: javascript:openProtocol('OB2205148517883530677','OB555695369079469033','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "CONTINGENT"
                              - gridcell "CONTINGENT"
                              - gridcell "IRB Panel"
                            ...
                            - row "25-06-034 Simon, Jones SUBMITTED to IRB SUBMITTED 0":
                              - gridcell "25-06-034":
                                - link "25-06-034":
                                  - /url: javascript:openProtocol('OB7903306867654635959','OB5378837557094429730','1','S')
                              - gridcell "Simon, Jones"
                              - gridcell "SUBMITTED to IRB":
                                - link "SUBMITTED to IRB":
                                  - /url: "javascript:performAction('OB5696470573461648460','OB7851618856219067041',\n\t\t\t\t\t\t\t\t\t\t\t\t'SUBMITTED to IRB',\n\t\t\t\t\t\t\t\t\t\t\t\t'S',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'',\n\t\t\t\t\t\t\t\t\t\t\t\t'1','')"
                              - gridcell "SUBMITTED"
                              - gridcell
                              - gridcell "0"
                    - row:
